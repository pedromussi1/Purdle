...
import { GameSurface } from '../games/purdle/GameSurface'
import { createWordleStore } from '../games/purdle/createStore'
import { StoreProvider, useStore } from '../games/purdle/StoreContext'
import { useDatePuzzle } from '../games/purdle/hooks/usePuzzle'
    ...
    return (
      <main className="game">
        <div className="puzzle-banner">
          No puzzle for {date}.{' '}
          <Link to="/play/archive" className="archive-back">
            Back to archive
          </Link>
        </div>
      </main>
